...
Для генерации большого JSON'а мы сгенерируем большие строки определённого вида (~100000 байт) и будем вставлять в команды, команды повторим большое число раз. А для начала напишем небольшой код на Python.
